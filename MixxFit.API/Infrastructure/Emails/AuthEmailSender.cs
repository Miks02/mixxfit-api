        ...
        var htmlBody = $"""
                         ...
                         <body style="margin: 0; padding: 24px 12px; background-color: #64748b; font-family: 'Inter', Arial, Helvetica, sans-serif; color: #1f2937;">
                             <div style="max-width: 560px; margin: 0 auto; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.4);">
                                 ...
                                 <div style="background-color: #eab308; background-image: linear-gradient(to bottom, #eab308, #ca8a04); padding: 28px 32px; text-align: center;">
                                 ...
                                 <div style="background-color: #d1d5db; padding: 40px 32px; text-align: center;">
                                     ...
                                     <a href="{resetUrl}"
                                        style="display: inline-block; padding: 14px 32px; border-radius: 6px; background-color: #fbbf24; background-image: linear-gradient(to bottom right, #fbbf24, #f59e0b); color: #1e293b; font-size: 18px; font-weight: 600; text-decoration: none; box-shadow: 0 0 5px #333333;">
                                         Reset password
                                     </a>
                                 ...
                                 <div style="background-color: #e5e7eb; padding: 24px 32px; border-top: 1px solid #9ca3af;">
