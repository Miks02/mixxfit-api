...
namespace MixxFit.VSA.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260307221638_MakeFitnessProfileNonNullableInUser")]
    partial class MakeFitnessProfileNonNullableInUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.CalorieEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.ExerciseEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.FitnessProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.SetEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.WeightEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.Workout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MixxFit.VSA.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.CalorieEntry", b =>
                {
                    b.HasOne("MixxFit.VSA.Domain.Entities.User", "User")
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.ExerciseEntry", b =>
                {
                    b.HasOne("MixxFit.VSA.Domain.Entities.Workout", "Workout")
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.FitnessProfile", b =>
                {
                    b.HasOne("MixxFit.VSA.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("MixxFit.VSA.Domain.Entities.FitnessProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MixxFit.VSA.Domain.Entities.SetEntry", b =>
                {
                    b.HasOne("MixxFit.VSA.Domain.Entities.ExerciseEntry", "ExerciseEntry")
                        .WithMany("Sets")
